...
class ChequesControllerTest < ActionController::TestCase
  ...
  test "should create cheque" do
    assert_difference('Cheque.count') do
      post :create, cheque: { payment_date: @cheque.payment_date, recipient: @cheque.recipient, value: @cheque.value }
    end
  ...
  test "should update cheque" do
    patch :update, id: @cheque, cheque: { payment_date: @cheque.payment_date, recipient: @cheque.recipient, value: @cheque.value }
    assert_redirected_to cheque_path(assigns(:cheque))
  end
